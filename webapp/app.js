...
(function () {
  ...
  function doneMany(data) {
    ...
    if (data.started) {
      // закрывших бота и чёрный список не считаем: им не уходит (AleX 26.09.2026)
      toast('Рассылка пошла: ' + data.count + ' чел. (кто закрыл бота и чёрный список — не в счёт), примерно '
